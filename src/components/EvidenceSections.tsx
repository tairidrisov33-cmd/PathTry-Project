...
export function ValidationSection({ language }: { language: Language }) {
  ...
  if (validation.recommendPercent !== null) cards.push({ value: `${format(validation.recommendPercent)}%`, label: ru ? 'порекомендуют другу: ответили «да» или «возможно», «нет» — никто' : 'would recommend it to a friend: answered “yes” or “maybe”, nobody said “no”' });
