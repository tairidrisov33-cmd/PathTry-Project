...
export default function VerificationCard({ slug, profession, match, strongest, skills, language, onClose }: { slug: string; profession: string; match: number; strongest: string; skills: SkillPoint[]; language: 'en' | 'ru'; onClose: () => void }) {
