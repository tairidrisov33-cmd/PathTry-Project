...
export const validation = {
  ...
  understandingBefore: 3.8 as number | null,
  ...
  learnedNewPercent: 93 as number | null,
  /** % who found the profession more interesting afterwards. */
  moreInterestedPercent: 60 as number | null,
  ...
  /** % who answered “yes” (50%) or “maybe” (50%) to recommending PathTry; nobody answered “no”. */
  recommendPercent: 100 as number | null,
  /** Average rating of how realistic the tasks felt (1–5). */
  realismScore: 4.5 as number | null,
  ...
  liked: [['Clear, convenient interface and design', 'Понятный и удобный интерфейс, оформление'], ['Good questions in the tasks', 'Хорошие вопросы в заданиях'], ['Explanations from the AI mentor', 'Пояснения от AI-наставника']] as [string, string][],
