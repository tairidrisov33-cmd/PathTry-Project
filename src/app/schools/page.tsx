...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title, description, alternates: pageAlternates('/schools', language), openGraph: { type: 'website', siteName: 'PathTry', title, description, url: '/schools', images: [OG_IMAGE] }, twitter: { card: 'summary_large_image', title, description, images: [OG_IMAGE] } };
}
